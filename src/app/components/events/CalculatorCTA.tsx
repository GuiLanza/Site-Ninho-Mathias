    ...
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
      <div className="rounded-2xl border border-amber-400/40 bg-zinc-900 p-8 md:p-14 text-center">
        ...
        <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">
          Ainda não sabe qual formação combina melhor?
        </h2>
        <p className="text-white/70 text-lg max-w-3xl mx-auto mb-8 leading-relaxed">
          Conte alguns detalhes sobre o evento. Indicamos entre Solo, Trio e Banda considerando
          público, espaço, acústica e a experiência musical desejada.
        </p>
        <Link
          to="/calculadora"
